...
const AdminMyTasksPageContent = () => {
    ...
    return (
        <div className="flex flex-col gap-4 h-full">
            ...
            />
            <BacklogView selectedProject={selectedProject} userRole="admin" viewType="my-tasks" />
        </div>
    )
}
